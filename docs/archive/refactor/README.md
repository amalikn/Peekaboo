...
- AXorcist boundary logs — `axorcist.md`, `axorcist-20251119_2156.md`
- Capture follow-ups — `capture-todo.md`
- ConfigCommand split/refactor — `config-command-split.md`, `config-refactor-20251117_2156.md`
- MCPCommand split — `mcp-command-split.md`
- MenuService refactor — `menu-service-refactor-20251118_2156.md`
